...
@CustomType
public final class TerminalLocationAddress {
    /**
    ...
    private TerminalLocationAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(TerminalLocationAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(TerminalLocationAddress defaults) {
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("TerminalLocationAddress", "country");
            }
        ...
        public TerminalLocationAddress build() {
            final var _resultValue = new TerminalLocationAddress();
