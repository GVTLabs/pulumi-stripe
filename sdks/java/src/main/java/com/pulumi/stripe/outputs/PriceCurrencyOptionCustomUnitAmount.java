...
@CustomType
public final class PriceCurrencyOptionCustomUnitAmount {
    /**
    ...
    public static Builder builder(PriceCurrencyOptionCustomUnitAmount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double preset;
        public Builder() {}
        public Builder(PriceCurrencyOptionCustomUnitAmount defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("PriceCurrencyOptionCustomUnitAmount", "enabled");
            }
        ...
        public PriceCurrencyOptionCustomUnitAmount build() {
            final var _resultValue = new PriceCurrencyOptionCustomUnitAmount();
