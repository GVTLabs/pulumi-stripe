...
@CustomType
public final class PersonRegisteredAddress {
    /**
    ...
    private PersonRegisteredAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(PersonRegisteredAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(PersonRegisteredAddress defaults) {
        ...
        public PersonRegisteredAddress build() {
            final var _resultValue = new PersonRegisteredAddress();
