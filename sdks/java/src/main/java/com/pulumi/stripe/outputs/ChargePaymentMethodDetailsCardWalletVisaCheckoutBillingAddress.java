...
@CustomType
public final class ChargePaymentMethodDetailsCardWalletVisaCheckoutBillingAddress {
    /**
    ...
    private ChargePaymentMethodDetailsCardWalletVisaCheckoutBillingAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(ChargePaymentMethodDetailsCardWalletVisaCheckoutBillingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(ChargePaymentMethodDetailsCardWalletVisaCheckoutBillingAddress defaults) {
        ...
        public ChargePaymentMethodDetailsCardWalletVisaCheckoutBillingAddress build() {
            final var _resultValue = new ChargePaymentMethodDetailsCardWalletVisaCheckoutBillingAddress();
