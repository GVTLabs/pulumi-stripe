...
@CustomType
public final class CustomerShippingAddress {
    /**
    ...
    public static Builder builder(CustomerShippingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(CustomerShippingAddress defaults) {
        ...
        public CustomerShippingAddress build() {
            final var _resultValue = new CustomerShippingAddress();
