...
@CustomType
public final class ChargePaymentMethodDetailsCardWalletMasterpassBillingAddress {
    /**
    ...
    private ChargePaymentMethodDetailsCardWalletMasterpassBillingAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(ChargePaymentMethodDetailsCardWalletMasterpassBillingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(ChargePaymentMethodDetailsCardWalletMasterpassBillingAddress defaults) {
        ...
        public ChargePaymentMethodDetailsCardWalletMasterpassBillingAddress build() {
            final var _resultValue = new ChargePaymentMethodDetailsCardWalletMasterpassBillingAddress();
