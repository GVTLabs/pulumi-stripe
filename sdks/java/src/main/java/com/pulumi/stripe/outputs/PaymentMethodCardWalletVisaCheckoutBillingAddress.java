...
@CustomType
public final class PaymentMethodCardWalletVisaCheckoutBillingAddress {
    /**
    ...
    public static Builder builder(PaymentMethodCardWalletVisaCheckoutBillingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(PaymentMethodCardWalletVisaCheckoutBillingAddress defaults) {
        ...
        public PaymentMethodCardWalletVisaCheckoutBillingAddress build() {
            final var _resultValue = new PaymentMethodCardWalletVisaCheckoutBillingAddress();
