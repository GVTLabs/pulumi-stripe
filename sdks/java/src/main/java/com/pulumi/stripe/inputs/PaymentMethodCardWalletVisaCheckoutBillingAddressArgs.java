...
public final class PaymentMethodCardWalletVisaCheckoutBillingAddressArgs extends com.pulumi.resources.ResourceArgs {

    public static final PaymentMethodCardWalletVisaCheckoutBillingAddressArgs Empty = new PaymentMethodCardWalletVisaCheckoutBillingAddressArgs();
    ...
    private PaymentMethodCardWalletVisaCheckoutBillingAddressArgs() {}

    private PaymentMethodCardWalletVisaCheckoutBillingAddressArgs(PaymentMethodCardWalletVisaCheckoutBillingAddressArgs $) {
        this.city = $.city;
    ...
    public static Builder builder(PaymentMethodCardWalletVisaCheckoutBillingAddressArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PaymentMethodCardWalletVisaCheckoutBillingAddressArgs();
        }

        public Builder(PaymentMethodCardWalletVisaCheckoutBillingAddressArgs defaults) {
            $ = new PaymentMethodCardWalletVisaCheckoutBillingAddressArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PaymentMethodCardWalletVisaCheckoutBillingAddressArgs build() {
            return $;
        }
    }
