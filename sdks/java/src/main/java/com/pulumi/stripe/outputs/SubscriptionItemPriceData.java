...
import com.pulumi.stripe.outputs.SubscriptionItemPriceDataRecurring;
...
@CustomType
public final class SubscriptionItemPriceData {
    /**
     ...
     * 
     */
    private SubscriptionItemPriceDataRecurring recurring;
    /**
     * @return **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
    ...
    private SubscriptionItemPriceData() {}
    /**
     * @return **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
     * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
     * 
     ...
     * 
     */
    public SubscriptionItemPriceDataRecurring recurring() {
    ...
    public static Builder builder(SubscriptionItemPriceData defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double unitAmountDecimal;
        public Builder() {}
        public Builder(SubscriptionItemPriceData defaults) {
        ...
        public Builder currency(String currency) {
            if (currency == null) {
              throw new MissingRequiredPropertyException("SubscriptionItemPriceData", "currency");
            }
        ...
        public Builder product(String product) {
            if (product == null) {
              throw new MissingRequiredPropertyException("SubscriptionItemPriceData", "product");
            }
            this.product = product;
            return this;
        }
        @CustomType.Setter
        public Builder recurring(SubscriptionItemPriceDataRecurring recurring) {
            if (recurring == null) {
              throw new MissingRequiredPropertyException("SubscriptionItemPriceData", "recurring");
            }
        ...
        public SubscriptionItemPriceData build() {
            final var _resultValue = new SubscriptionItemPriceData();
