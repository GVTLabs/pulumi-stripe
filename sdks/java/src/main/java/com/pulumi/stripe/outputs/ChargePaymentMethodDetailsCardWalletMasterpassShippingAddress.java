...
@CustomType
public final class ChargePaymentMethodDetailsCardWalletMasterpassShippingAddress {
    /**
    ...
    private ChargePaymentMethodDetailsCardWalletMasterpassShippingAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(ChargePaymentMethodDetailsCardWalletMasterpassShippingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(ChargePaymentMethodDetailsCardWalletMasterpassShippingAddress defaults) {
        ...
        public ChargePaymentMethodDetailsCardWalletMasterpassShippingAddress build() {
            final var _resultValue = new ChargePaymentMethodDetailsCardWalletMasterpassShippingAddress();
