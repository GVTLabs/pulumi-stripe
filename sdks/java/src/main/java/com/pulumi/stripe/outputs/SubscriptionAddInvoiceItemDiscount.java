...
@CustomType
public final class SubscriptionAddInvoiceItemDiscount {
    /**
    ...
    public static Builder builder(SubscriptionAddInvoiceItemDiscount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String promotionCode;
        public Builder() {}
        public Builder(SubscriptionAddInvoiceItemDiscount defaults) {
        ...
        public SubscriptionAddInvoiceItemDiscount build() {
            final var _resultValue = new SubscriptionAddInvoiceItemDiscount();
