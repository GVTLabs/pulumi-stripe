...
public final class ProductDefaultPriceDataCurrencyOptionTierArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProductDefaultPriceDataCurrencyOptionTierArgs Empty = new ProductDefaultPriceDataCurrencyOptionTierArgs();
    ...
    private ProductDefaultPriceDataCurrencyOptionTierArgs() {}

    private ProductDefaultPriceDataCurrencyOptionTierArgs(ProductDefaultPriceDataCurrencyOptionTierArgs $) {
    ...
    public static Builder builder(ProductDefaultPriceDataCurrencyOptionTierArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProductDefaultPriceDataCurrencyOptionTierArgs();
        }

        public Builder(ProductDefaultPriceDataCurrencyOptionTierArgs defaults) {
            $ = new ProductDefaultPriceDataCurrencyOptionTierArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param upTo Specifies the upper bound of this tier. The lower bound of a tier is the upper bound of the previous tier adding one. Use &lt;span pulumi-lang-nodejs=&#34;`inf`&#34; pulumi-lang-dotnet=&#34;`Inf`&#34; pulumi-lang-go=&#34;`inf`&#34; pulumi-lang-python=&#34;`inf`&#34; pulumi-lang-yaml=&#34;`inf`&#34; pulumi-lang-java=&#34;`inf`&#34; pulumi-lang-hcl=&#34;`inf`&#34;&gt;`inf`&lt;/span&gt; to define a fallback tier.
         * 
         * @return builder
         * 
         */
        ...
        public ProductDefaultPriceDataCurrencyOptionTierArgs build() {
            if ($.upTo == null) {
                throw new MissingRequiredPropertyException("ProductDefaultPriceDataCurrencyOptionTierArgs", "upTo");
            }
            return $;
        }
    }
