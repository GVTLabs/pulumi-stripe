...
@CustomType
public final class SubscriptionAddInvoiceItemPriceData {
    /**
    ...
    private SubscriptionAddInvoiceItemPriceData() {}
    /**
     * @return **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
     * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
     * 
    ...
    public static Builder builder(SubscriptionAddInvoiceItemPriceData defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double unitAmountDecimal;
        public Builder() {}
        public Builder(SubscriptionAddInvoiceItemPriceData defaults) {
        ...
        public Builder currency(String currency) {
            if (currency == null) {
              throw new MissingRequiredPropertyException("SubscriptionAddInvoiceItemPriceData", "currency");
            }
        ...
        public Builder product(String product) {
            if (product == null) {
              throw new MissingRequiredPropertyException("SubscriptionAddInvoiceItemPriceData", "product");
            }
        ...
        public SubscriptionAddInvoiceItemPriceData build() {
            final var _resultValue = new SubscriptionAddInvoiceItemPriceData();
