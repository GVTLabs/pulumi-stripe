...
@CustomType
public final class ChargeShippingAddress {
    /**
    ...
    public static Builder builder(ChargeShippingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(ChargeShippingAddress defaults) {
        ...
        public ChargeShippingAddress build() {
            final var _resultValue = new ChargeShippingAddress();
