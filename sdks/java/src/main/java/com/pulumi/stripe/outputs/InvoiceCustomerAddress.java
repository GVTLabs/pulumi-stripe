...
@CustomType
public final class InvoiceCustomerAddress {
    /**
    ...
    private InvoiceCustomerAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(InvoiceCustomerAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(InvoiceCustomerAddress defaults) {
        ...
        public InvoiceCustomerAddress build() {
            final var _resultValue = new InvoiceCustomerAddress();
