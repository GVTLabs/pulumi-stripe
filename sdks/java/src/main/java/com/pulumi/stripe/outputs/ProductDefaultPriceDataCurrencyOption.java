...
@CustomType
public final class ProductDefaultPriceDataCurrencyOption {
    /**
    ...
    public static Builder builder(ProductDefaultPriceDataCurrencyOption defaults) {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("ProductDefaultPriceDataCurrencyOption", "key");
            }
            this.key = key;
            return this;
        }
