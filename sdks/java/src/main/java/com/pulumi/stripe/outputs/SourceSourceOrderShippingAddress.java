...
@CustomType
public final class SourceSourceOrderShippingAddress {
    /**
    ...
    private SourceSourceOrderShippingAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(SourceSourceOrderShippingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(SourceSourceOrderShippingAddress defaults) {
        ...
        public Builder line1(String line1) {
            if (line1 == null) {
              throw new MissingRequiredPropertyException("SourceSourceOrderShippingAddress", "line1");
            }
            this.line1 = line1;
            return this;
        }
        ...
        public SourceSourceOrderShippingAddress build() {
            final var _resultValue = new SourceSourceOrderShippingAddress();
