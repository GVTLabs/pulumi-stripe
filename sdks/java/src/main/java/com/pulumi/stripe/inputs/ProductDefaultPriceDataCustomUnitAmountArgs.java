...
public final class ProductDefaultPriceDataCustomUnitAmountArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProductDefaultPriceDataCustomUnitAmountArgs Empty = new ProductDefaultPriceDataCustomUnitAmountArgs();
    ...
    private ProductDefaultPriceDataCustomUnitAmountArgs() {}

    private ProductDefaultPriceDataCustomUnitAmountArgs(ProductDefaultPriceDataCustomUnitAmountArgs $) {
    ...
    public static Builder builder(ProductDefaultPriceDataCustomUnitAmountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProductDefaultPriceDataCustomUnitAmountArgs();
        }

        public Builder(ProductDefaultPriceDataCustomUnitAmountArgs defaults) {
            $ = new ProductDefaultPriceDataCustomUnitAmountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProductDefaultPriceDataCustomUnitAmountArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("ProductDefaultPriceDataCustomUnitAmountArgs", "enabled");
            }
            return $;
        }
    }
