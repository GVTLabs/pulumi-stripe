...
@CustomType
public final class PersonAddressKana {
    /**
     * @return City/Ward.
     * 
     */
    ...
    public static Builder builder(PersonAddressKana defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String town;
        public Builder() {}
        public Builder(PersonAddressKana defaults) {
        ...
        public PersonAddressKana build() {
            final var _resultValue = new PersonAddressKana();
