...
public final class ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs Empty = new ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs();
    ...
    private ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs() {}

    private ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs(ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs $) {
    ...
    public static Builder builder(ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs();
        }

        public Builder(ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs defaults) {
            $ = new ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs", "enabled");
            }
            return $;
        }
    }
