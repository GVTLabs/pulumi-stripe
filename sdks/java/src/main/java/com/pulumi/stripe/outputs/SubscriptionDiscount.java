...
public final class SubscriptionDiscount {
    ...
    public static Builder builder(SubscriptionDiscount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String promotionCode;
        public Builder() {}
        public Builder(SubscriptionDiscount defaults) {
        ...
        public SubscriptionDiscount build() {
            final var _resultValue = new SubscriptionDiscount();
