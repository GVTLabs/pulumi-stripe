...
@CustomType
public final class SourceOwnerAddress {
    /**
    ...
    public static Builder builder(SourceOwnerAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(SourceOwnerAddress defaults) {
        ...
        public SourceOwnerAddress build() {
            final var _resultValue = new SourceOwnerAddress();
