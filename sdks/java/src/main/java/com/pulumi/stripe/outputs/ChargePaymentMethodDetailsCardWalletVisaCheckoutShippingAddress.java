...
@CustomType
public final class ChargePaymentMethodDetailsCardWalletVisaCheckoutShippingAddress {
    /**
    ...
    private ChargePaymentMethodDetailsCardWalletVisaCheckoutShippingAddress() {}
    /**
     * @return City, district, suburb, town, or village.
     * 
     */
    ...
    public static Builder builder(ChargePaymentMethodDetailsCardWalletVisaCheckoutShippingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(ChargePaymentMethodDetailsCardWalletVisaCheckoutShippingAddress defaults) {
        ...
        public ChargePaymentMethodDetailsCardWalletVisaCheckoutShippingAddress build() {
            final var _resultValue = new ChargePaymentMethodDetailsCardWalletVisaCheckoutShippingAddress();
