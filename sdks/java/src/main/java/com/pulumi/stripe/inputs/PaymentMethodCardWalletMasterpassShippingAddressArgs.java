...
public final class PaymentMethodCardWalletMasterpassShippingAddressArgs extends com.pulumi.resources.ResourceArgs {

    public static final PaymentMethodCardWalletMasterpassShippingAddressArgs Empty = new PaymentMethodCardWalletMasterpassShippingAddressArgs();
    ...
    private PaymentMethodCardWalletMasterpassShippingAddressArgs() {}

    private PaymentMethodCardWalletMasterpassShippingAddressArgs(PaymentMethodCardWalletMasterpassShippingAddressArgs $) {
        this.city = $.city;
    ...
    public static Builder builder(PaymentMethodCardWalletMasterpassShippingAddressArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PaymentMethodCardWalletMasterpassShippingAddressArgs();
        }

        public Builder(PaymentMethodCardWalletMasterpassShippingAddressArgs defaults) {
            $ = new PaymentMethodCardWalletMasterpassShippingAddressArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PaymentMethodCardWalletMasterpassShippingAddressArgs build() {
            return $;
        }
    }
