...
@CustomType
public final class InvoiceDiscount {
    /**
    ...
    public static Builder builder(InvoiceDiscount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String promotionCode;
        public Builder() {}
        public Builder(InvoiceDiscount defaults) {
        ...
        public InvoiceDiscount build() {
            final var _resultValue = new InvoiceDiscount();
