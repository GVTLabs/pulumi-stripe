...
namespace Pulumi.Stripe.Outputs
{
    ...
    [OutputType]
    public sealed class PromotionCodeRestriction
    {
        /// <summary>
        /// Promotion code restrictions defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
        /// </summary>
        public readonly ImmutableArray<Outputs.PromotionCodeRestrictionCurrencyOption> CurrencyOptions;
        /// <summary>
        ...
        private PromotionCodeRestriction(
            ImmutableArray<Outputs.PromotionCodeRestrictionCurrencyOption> currencyOptions,
