...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class ProductDefaultPriceDataCurrencyOptionArgs : global::Pulumi.ResourceArgs
    {
        [Input("customUnitAmounts")]
        private InputList<Inputs.ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs>? _customUnitAmounts;

        /// <summary>
        /// When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
        /// </summary>
        public InputList<Inputs.ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs> CustomUnitAmounts
        {
            get => _customUnitAmounts ?? (_customUnitAmounts = new InputList<Inputs.ProductDefaultPriceDataCurrencyOptionCustomUnitAmountArgs>());
        ...
        [Input("tiers")]
        private InputList<Inputs.ProductDefaultPriceDataCurrencyOptionTierArgs>? _tiers;
        ...
        /// </summary>
        public InputList<Inputs.ProductDefaultPriceDataCurrencyOptionTierArgs> Tiers
        {
            get => _tiers ?? (_tiers = new InputList<Inputs.ProductDefaultPriceDataCurrencyOptionTierArgs>());
            set => _tiers = value;
        }
        ...
        public ProductDefaultPriceDataCurrencyOptionArgs()
        {
        }
        public static new ProductDefaultPriceDataCurrencyOptionArgs Empty => new ProductDefaultPriceDataCurrencyOptionArgs();
    }
}
