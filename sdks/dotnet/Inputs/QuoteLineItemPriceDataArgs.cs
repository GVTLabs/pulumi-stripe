...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class QuoteLineItemPriceDataArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("recurring")]
        public Input<Inputs.QuoteLineItemPriceDataRecurringArgs>? Recurring { get; set; }
        ...
        public QuoteLineItemPriceDataArgs()
        {
        }
        public static new QuoteLineItemPriceDataArgs Empty => new QuoteLineItemPriceDataArgs();
    }
}
