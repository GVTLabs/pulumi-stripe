...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class SubscriptionItemPriceDataArgs : global::Pulumi.ResourceArgs
    {
        ...
        private Input<Inputs.SubscriptionItemPriceDataRecurringArgs>? _recurring;
        ...
        /// </summary>
        public Input<Inputs.SubscriptionItemPriceDataRecurringArgs>? Recurring
        {
            get => _recurring;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _recurring = Output.Tuple<Input<Inputs.SubscriptionItemPriceDataRecurringArgs>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        public SubscriptionItemPriceDataArgs()
        {
        }
        public static new SubscriptionItemPriceDataArgs Empty => new SubscriptionItemPriceDataArgs();
    }
}
