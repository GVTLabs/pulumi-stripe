...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class ProductDefaultPriceDataGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ProductDefaultPriceDataCurrencyOptionGetArgs>? _currencyOptions;

        /// <summary>
        /// Prices defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
        /// </summary>
        public InputList<Inputs.ProductDefaultPriceDataCurrencyOptionGetArgs> CurrencyOptions
        {
            get => _currencyOptions ?? (_currencyOptions = new InputList<Inputs.ProductDefaultPriceDataCurrencyOptionGetArgs>());
            set => _currencyOptions = value;
        }

        [Input("customUnitAmounts")]
        private InputList<Inputs.ProductDefaultPriceDataCustomUnitAmountGetArgs>? _customUnitAmounts;

        /// <summary>
        /// When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
        /// </summary>
        public InputList<Inputs.ProductDefaultPriceDataCustomUnitAmountGetArgs> CustomUnitAmounts
        {
            get => _customUnitAmounts ?? (_customUnitAmounts = new InputList<Inputs.ProductDefaultPriceDataCustomUnitAmountGetArgs>());
        ...
        [Input("recurrings")]
        private InputList<Inputs.ProductDefaultPriceDataRecurringGetArgs>? _recurrings;
        ...
        /// </summary>
        public InputList<Inputs.ProductDefaultPriceDataRecurringGetArgs> Recurrings
        {
            get => _recurrings ?? (_recurrings = new InputList<Inputs.ProductDefaultPriceDataRecurringGetArgs>());
        ...
        public ProductDefaultPriceDataGetArgs()
        {
        }
        public static new ProductDefaultPriceDataGetArgs Empty => new ProductDefaultPriceDataGetArgs();
    }
}
