...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class PaymentIntentPaymentMethodOptionsKlarnaSubscriptionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("nextBilling")]
        public Input<Inputs.PaymentIntentPaymentMethodOptionsKlarnaSubscriptionNextBillingArgs>? NextBilling { get; set; }
        ...
        public PaymentIntentPaymentMethodOptionsKlarnaSubscriptionArgs()
        {
        }
        public static new PaymentIntentPaymentMethodOptionsKlarnaSubscriptionArgs Empty => new PaymentIntentPaymentMethodOptionsKlarnaSubscriptionArgs();
    }
}
