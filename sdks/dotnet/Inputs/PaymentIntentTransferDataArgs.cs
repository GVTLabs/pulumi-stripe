...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class PaymentIntentTransferDataArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("paymentData")]
        public Input<Inputs.PaymentIntentTransferDataPaymentDataArgs>? PaymentData { get; set; }

        public PaymentIntentTransferDataArgs()
        {
        }
        public static new PaymentIntentTransferDataArgs Empty => new PaymentIntentTransferDataArgs();
    }
}
