...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class ProductDefaultPriceDataArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ProductDefaultPriceDataCurrencyOptionArgs>? _currencyOptions;

        /// <summary>
        /// Prices defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://stripe.com/docs/currencies).
        /// </summary>
        public InputList<Inputs.ProductDefaultPriceDataCurrencyOptionArgs> CurrencyOptions
        {
            get => _currencyOptions ?? (_currencyOptions = new InputList<Inputs.ProductDefaultPriceDataCurrencyOptionArgs>());
        ...
        public ProductDefaultPriceDataArgs()
        {
        }
        public static new ProductDefaultPriceDataArgs Empty => new ProductDefaultPriceDataArgs();
    }
}
