...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class SubscriptionItemPriceDataRecurringGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("intervalCount")]
        private Input<double>? _intervalCount;

        /// <summary>
        /// **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
        /// The number of intervals between subscription billings. For example, `interval=month` and `interval_count=3` bills every 3 months. Maximum of three years interval allowed (3 years, 36 months, or 156 weeks).
        /// </summary>
        public Input<double>? IntervalCount
        {
            get => _intervalCount;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _intervalCount = Output.Tuple<Input<double>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }

        public SubscriptionItemPriceDataRecurringGetArgs()
        {
        }
        public static new SubscriptionItemPriceDataRecurringGetArgs Empty => new SubscriptionItemPriceDataRecurringGetArgs();
    }
}
