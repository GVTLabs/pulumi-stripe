...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class QuoteLineItemPriceDataGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("recurring")]
        public Input<Inputs.QuoteLineItemPriceDataRecurringGetArgs>? Recurring { get; set; }
        ...
        public QuoteLineItemPriceDataGetArgs()
        {
        }
        public static new QuoteLineItemPriceDataGetArgs Empty => new QuoteLineItemPriceDataGetArgs();
    }
}
