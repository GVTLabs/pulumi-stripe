...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class PriceCurrencyOptionArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.PriceCurrencyOptionCustomUnitAmountArgs>? _customUnitAmounts;

        /// <summary>
        /// When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
        /// </summary>
        public InputList<Inputs.PriceCurrencyOptionCustomUnitAmountArgs> CustomUnitAmounts
        {
            get => _customUnitAmounts ?? (_customUnitAmounts = new InputList<Inputs.PriceCurrencyOptionCustomUnitAmountArgs>());
