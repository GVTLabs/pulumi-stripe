...
namespace Pulumi.Stripe.Inputs
{
    ...
    public sealed class SubscriptionItemPriceDataGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private Input<Inputs.SubscriptionItemPriceDataRecurringGetArgs>? _recurring;
        ...
        /// </summary>
        public Input<Inputs.SubscriptionItemPriceDataRecurringGetArgs>? Recurring
        {
            get => _recurring;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _recurring = Output.Tuple<Input<Inputs.SubscriptionItemPriceDataRecurringGetArgs>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        public SubscriptionItemPriceDataGetArgs()
        {
        }
        public static new SubscriptionItemPriceDataGetArgs Empty => new SubscriptionItemPriceDataGetArgs();
    }
}
